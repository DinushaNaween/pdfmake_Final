		...
		'Each cell-element can set a rowSpan or colSpan',
		{
			...
			table: {
				...
				body: [
					...
					[{ rowSpan: 3, text: 'rowSpan set to 3\nLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor' }, 'Sample value 4', 'Sample value 5'],
					['', 'Sample value 6', 'Sample value 7'],
					['', 'Sample value 9', 'Sample value 10'],
					['Sample value 11', { colSpan: 2, rowSpan: 2, text: 'Both:\nrowSpan and colSpan\ncan be defined at the same time' }, ''],
					['Sample value 12', '', ''],
				]
			}
		},
