...
class PdfPrinter {
  ...
  createPdfKitDocument(docDefinition, options = {}) {
    ...
    this.pdfKitDoc = new _PDFDocument.default(this.fontDescriptors, docDefinition.images, pdfOptions);
    setMetadata(docDefinition, this.pdfKitDoc);
    const builder = new _LayoutBuilder.default(pageSize, fixPageMargins(docDefinition.pageMargins || 40), new _SVGMeasure.default());
